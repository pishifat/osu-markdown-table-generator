...
async function generate() {
    ...
    for (const unsplitRow of data) {
        ...
        output += `![][flag_${user1.country}] [${user1.username}](https://osu.ppy.sh/users/${user1.user_id}), ![][flag_${user1.country}] [${user2.username}](https://osu.ppy.sh/users/${user2.user_id}) | *TBD* |`;
